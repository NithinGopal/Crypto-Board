...
const CryptoDetails = () => {
  ...
  const stats = [
    ...
    { title: '24h Volume', value: `$ ${cryptoDetails?.name && cryptoDetails['24hVolume'] && millify(cryptoDetails['24hVolume'])}`, icon: <ThunderboltOutlined /> },
        ...
        <Col className='coin-value-statistics'>
          ...
          {stats?.map(({ icon, title, value }) => (
            <Col className='coin-stats'>
              <Col className='coin-stats-title'>
                <Text>{icon}</Text>
                <Text>{title}</Text>
              </Col>
